...
public class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.Holder> {
    ...
    public ContentAdapter(Listener listener) { this.listener = listener; }
    ...
    @Override public void onBindViewHolder(@NonNull Holder h, int position) {
        ...
        Glide.with(h.itemView).load(item.image).centerCrop().placeholder(R.drawable.ic_flix_pro).error(R.drawable.ic_flix_pro).into(h.poster);
